...
if (isset($opts['help']) || $argc < 2) {
    echo <<<HELP
用法：php /alidata/www/didi365/swoole.php 选项 ... 命令[start|stop|restart|reload|close|status|list]
...
参数说明
    ...
    -h, --host  指定监听ip,例如 php /alidata/www/didi365/swoole.php -h127.0.0.1
    -p, --port  指定监听端口port， 例如 php /alidata/www/didi365/swoole.php -h127.0.0.1 -p9520
    -n, --name  指定服务进程名称，例如 php /alidata/www/didi365/swoole.php -ntest start, 则进程名称为SWOOLE_TASK_NAME_PRE-name
